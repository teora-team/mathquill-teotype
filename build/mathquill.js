...
LatexCmds["\u2217"] = LatexCmds.ast = LatexCmds.loast = LatexCmds.lowast = bind(
  BinaryOperator,
  "\\ast ",
  "&lowast;"
);
...
LatexCmds["\u2262"] = LatexCmds.notequiv = LatexCmds.nequiv = bind(
  BinaryOperator,
  "\\not\\equiv ",
  "&#8802;"
);
...
LatexCmds.rightleftarrows = bind(
  VanillaSymbol,
  "\\rightleftarrows  ",
  "&#8644;"
);
LatexCmds.leftrightarrows = bind(
  VanillaSymbol,
  "\\leftrightarrows  ",
  "&#8646;"
);
LatexCmds.rightleftharpoons = bind(
  VanillaSymbol,
  "\\rightleftharpoons ",
  "&#8652;"
);
LatexCmds.leftrightharpoons = bind(
  VanillaSymbol,
  "\\leftrightharpoons ",
  "&#8651;"
);
...
LatexCmds.star = bind(VanillaSymbol, "\\star", "&#128969;");
LatexCmds.maltese = bind(VanillaSymbol, "\\maltese", "&#10016;");
LatexCmds.bigstar = bind(VanillaSymbol, "\\bigstar", "&#9733;");
LatexCmds.copyright = bind(VanillaSymbol, "\\copyright", "&#169;");
LatexCmds.circledR = bind(VanillaSymbol, "\\circledR", "&#174;");
LatexCmds.approxeq = bind(VanillaSymbol, "\\approxeq", "\u224a");
LatexCmds.ggg = bind(VanillaSymbol, "\\ggg", "\u22d9");
LatexCmds.lll = bind(VanillaSymbol, "\\lll", "\u22d8");
LatexCmds.ncong = bind(VanillaSymbol, "\\ncong", "\u2246");
LatexCmds.ngeq = bind(VanillaSymbol, "\\ngeq", "\u2271");
LatexCmds.nleq = bind(VanillaSymbol, "\\nleq", "\u2270");
  ...
  _.parser = function () {
    ...
    return anyOf(suffixes)
      .then(function (suffix) {
        return optWhitespace.then(succeed(LatexCmds[_.suffixes[suffix]]()));
      })
...
LatexCmds.empty = LatexCmds.emptyset = bind(
  BinaryOperator,
  "\\empty ",
  "&#x2205;"
);
LatexCmds.o = LatexCmds.O = LatexCmds.oslash = LatexCmds.Oslash = LatexCmds.nothing = LatexCmds.varnothing = bind(
  BinaryOperator,
  "\\varnothing ",
  "&empty;"
);
...
//fonts
LatexCmds.cal = LatexCmds.mathcal = bind(
  Style,
  "\\mathcal",
  "span",
...
LatexCmds.sout = LatexCmds.bar = bind(
  Style,
  "\\sout",
  "span",
  'class="mq-non-leaf mq-sout"'
);
LatexCmds.cancel = LatexCmds.bar = bind(
  Style,
  "\\cancel",
  "span",
  'class="mq-non-leaf mq-cancel"'
);
LatexCmds.bcancel = LatexCmds.bar = bind(
  Style,
  "\\bcancel",
  "span",
  'class="mq-non-leaf mq-bcancel"'
);
LatexCmds.xcancel = LatexCmds.bar = bind(
  Style,
  "\\xcancel",
  "span",
  'class="mq-non-leaf mq-xcancel"'
);
LatexCmds.boxed = LatexCmds.bar = bind(
  Style,
  "\\boxed",
  "span",
...
LatexCmds.overlinesegment = bind(
  OverUnderArrow,
  "\\overlinesegment",
  'class="mq-non-leaf mq-overlinesegment mq-arrow-leftright"'
);
LatexCmds.underrightarrow = bind(
  OverUnderArrow,
  "\\underrightarrow",
  'class="mq-non-leaf mq-underarrow mq-arrow-right"'
);
LatexCmds.underleftarrow = bind(
  OverUnderArrow,
  "\\underleftarrow",
  'class="mq-non-leaf mq-underarrow mq-arrow-left"'
);
LatexCmds.underleftrightarrow = bind(
  OverUnderArrow,
  "\\underleftrightarrow",
  'class="mq-non-leaf mq-underarrow mq-arrow-leftright"'
);
LatexCmds.underlinesegment = bind(
  OverUnderArrow,
  "\\underlinesegment",
  'class="mq-non-leaf mq-underlinesegment mq-arrow-leftright"'
);
...
// so perhaps not?
var AboveAndBelowHarpoons = (LatexCmds.xrightleftharpoons = P(
  Harpoons,
  function (_, super_) {
    _.ctrlSeq = "\\xrightleftharpoons";
    _.htmlTemplate =
    ...
    _.parser = function () {
      ...
      return latexMathParser.optBlock
        ...
        .or(
          latexMathParser.block.map(function (block) {
...
var AboveAndBelowXleftrightharpoons = (LatexCmds.xleftrightharpoons = P(
  Xleftrightharpoons,
  function (_, super_) {
    _.ctrlSeq = "\\xleftrightharpoons";
    _.htmlTemplate =
...
// Squareroot handle them in a similar manner (separate classes and templates),
// so perhaps not?
var AboveAndBelowXright = (LatexCmds.xrightarrow = P(
  Xright,
  function (_, super_) {
    _.ctrlSeq = "\\xrightarrow";
    _.htmlTemplate =
...
var AboveAndBelowXleftright = (LatexCmds.xleftrightarrow = P(
  Xleftright,
  function (_, super_) {
    _.ctrlSeq = "\\xleftrightarrow";
    _.htmlTemplate =
...
var AboveAndBelowXhookright = (LatexCmds.xhookrightarrow = P(
  Xhookright,
  function (_, super_) {
    _.ctrlSeq = "\\xhookrightarrow";
    _.htmlTemplate =
...
var AboveAndBelowXhookleft = (LatexCmds.xhookleftarrow = P(
  Xhookleft,
  function (_, super_) {
    _.ctrlSeq = "\\xhookleftarrow";
    _.htmlTemplate =
...
var AboveAndBelowXtofrom = (LatexCmds.xtofrom = P(
  Xtofrom,
  function (_, super_) {
    _.ctrlSeq = "\\xtofrom";
    _.htmlTemplate =
...
var AboveAndBelowXlongequal = (LatexCmds.xlongequal = P(
  Xlongequal,
  function (_, super_) {
    _.ctrlSeq = "\\xlongequal";
    _.htmlTemplate =
...
var AboveAndBelowXmapsto = (LatexCmds.xmapsto = P(
  Xmapsto,
  function (_, super_) {
    _.ctrlSeq = "\\xmapsto";
    _.htmlTemplate =
...
LatexCmds["overgroup"] = LatexCmds.overarc = bind(
  Style,
  "\\overgroup",
  "span",
...
LatexCmds["overbrace"] = LatexCmds.overarc = bind(
  Style,
  "\\overbrace",
  "span",
  'class="mq-non-leaf mq-overarc"'
...
LatexCmds["undergroup"] = LatexCmds.underarc = bind(
  Style,
  "\\undergroup",
  "span",
  'class="mq-non-leaf mq-underarc"'
);
// TODO overbrace is totally different from what is already done, so i'll make something really practical
LatexCmds["underbrace"] = LatexCmds.overarc = bind(
  Style,
  "\\underbrace",
  "span",
  'class="mq-non-leaf mq-underarc"'
...
LatexCmds.bigg = LatexCmds.intsub = LatexCmds.integralsubstitution = P(
  // HACK FIXME
  SummationNotation,
  function (_, super_) {
    _.init = function () {
...
var Matrix = (Environments.matrix = P(Environment, function (_, super_) {
  ...
  _.html = function () {
    ...
    this.htmlTemplate =
      '<span class="mq-matrix mq-matrix-' +
      this.environment +
      ' mq-non-leaf">' +
  ...
  _.createBlocks = function () {
    if (
      ...
      this.ctrlSeq == "bmatrix" ||
      this.ctrlSeq == "Bmatrix" ||
      this.ctrlSeq == "vmatrix" ||
      this.ctrlSeq == "Vmatrix" ||
      this.ctrlSeq == "array"
    ) {
      this.blocks = [
